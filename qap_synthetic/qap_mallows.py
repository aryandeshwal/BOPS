...
def bo_loop(benchmark_index, kernel_type):
    ...
    for nruns in range(20):
        ...
        for num_iters in range(n_init, n_evals):
            ...
            torch.save({'inputs_selected':train_x, 'outputs':outputs, 'train_y':train_y}, 'qap_botorch_'+kernel_type+'_EI_benchmark_index_'+str(benchmark_index)+'_nrun_'+str(nruns)+'.pkl')
